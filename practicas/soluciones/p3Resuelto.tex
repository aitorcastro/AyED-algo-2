...
\begin{itemize}
    ...
    \begin{tad}{Multiconjunto$\langle$T$\rangle$}
        ...
        \begin{proc}{vacio}{\In mc: Multiconjunto$\langle$T$\rangle$}{\bool}
            \requiere{True}
            \asegura{res \iff (|mc.elementos| = 0)}
        \end{proc}

        \begin{proc}{multiplicidad}{\In mc: Multiconjunto$\langle$T$\rangle$, \In e: T}{\ent}
            \requiere{\existe[unalinea]{i}{\ent}{(0 \leq i < |mc.elementos|) \land mc.elementos[i].e = e}}
            \asegura{\existe[unalinea]{i}{\ent}{(0 \leq i < |mc.elementos|) \land mc.elementos[i].e = e \land res = mc.elementos[i].multi}}
        \end{proc}
        incompletoooo
    \end{tad}
